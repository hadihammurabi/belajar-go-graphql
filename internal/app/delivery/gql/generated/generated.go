...
type QueryResolver interface {
	Login(ctx context.Context, email string, password string) (*model.LoginResult, error)
}
...
var sources = []*ast.Source{
	{Name: "internal/app/delivery/gql/schema.graphqls", Input: `type LoginResult {
  token: String!
}
...
func (ec *executionContext) _Query_login(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNLoginResult2ᚖgithubᚗcomᚋhadihammurabiᚋbelajarᚑgoᚑgraphqlᚋinternalᚋappᚋdeliveryᚋgqlᚋmodelᚐLoginResult(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNLoginResult2githubᚗcomᚋhadihammurabiᚋbelajarᚑgoᚑgraphqlᚋinternalᚋappᚋdeliveryᚋgqlᚋmodelᚐLoginResult(ctx context.Context, sel ast.SelectionSet, v model.LoginResult) graphql.Marshaler {
	return ec._LoginResult(ctx, sel, &v)
}

func (ec *executionContext) marshalNLoginResult2ᚖgithubᚗcomᚋhadihammurabiᚋbelajarᚑgoᚑgraphqlᚋinternalᚋappᚋdeliveryᚋgqlᚋmodelᚐLoginResult(ctx context.Context, sel ast.SelectionSet, v *model.LoginResult) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
